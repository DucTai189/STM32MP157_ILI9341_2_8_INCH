...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, ILI9341_RESET_Pin|ILI9341_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ILI9341_DC_GPIO_Port, ILI9341_DC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ILI9341_RESET_Pin ILI9341_CS_Pin */
  GPIO_InitStruct.Pin = ILI9341_RESET_Pin|ILI9341_CS_Pin;
